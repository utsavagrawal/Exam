...
$sql = "select * from Subject_Master where Subject_Id=".$Id."";
// Execute query
...
?>
                  <form method="post" action="UpdateSubject.php">
                    <table width="100%" border="0">
                      <tr>
                        <td height="32"><span class="style8">Subject Id</span></td>
                      ...
                      <tr>
                        <td height="36"><span class="style8">Subject Name:</span></td>
